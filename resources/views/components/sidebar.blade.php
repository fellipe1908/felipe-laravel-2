...
<aside class="w-full md:w-1/3 flex flex-col items-center px-3">
    ...
    <div class="w-full bg-white shadow flex flex-col my-4 p-6">
        <h3 class="text-xl font-semibold mb-3">Categorias</h3>
    ...
    <div class="w-full bg-white shadow flex flex-col my-4 p-6">
        ...
        <a href="{{route('about-us-sidebar')}}" class="w-full bg-blue-800 text-white font-bold text-sm uppercase rounded hover:bg-blue-700 flex items-center justify-center px-3 py-5 mt-4">
            Projeto
        </a>
