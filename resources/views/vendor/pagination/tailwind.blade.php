            ...
            <div>
                ...
                {{-- Previous Page Link --}}
                    @if (!$paginator->onFirstPage())
                        ...
                        class="h-10 w-10 font-semibold text-gray-800 hover:text-gray-900 text-sm flex items-center justify-center mr-5" 
                    ...
                    {{-- Next Page Link --}}
                    @if ($paginator->hasMorePages())
                        <a href="{{ $paginator->nextPageUrl() }}" rel="next" class="h-10 w-10 font-semibold text-gray-800 hover:text-gray-900 text-sm flex items-center justify-center ml-5" 
                        aria-label="{{ __('pagination.next') }}">
                        Next
